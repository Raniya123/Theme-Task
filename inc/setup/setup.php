...
function setup() {
	 ...
	 * references of wd_s
	 */
	load_theme_textdomain( 'test-theme', get_template_directory() . '/build/languages' );
	...
	register_nav_menus(
		[
			...
			'footer'  => esc_html__( 'Footer Menu', 'test-theme' ),
			'mobile'  => esc_html__( 'Mobile Menu', 'test-theme' ),
		]
	);
	...
	add_theme_support(
		...
		[
			[
				'name' => __( 'Small', 'test-theme' ),
				'size' => 12,
				'slug' => 'small',
			],
			[
				'name' => __( 'Normal', 'test-theme' ),
				'size' => 16,
				'slug' => 'normal',
			],
			[
				'name' => __( 'Large', 'test-theme' ),
				'size' => 36,
				'slug' => 'large',
			],
			[
				'name' => __( 'Huge', 'test-theme' ),
				'size' => 50,
				'slug' => 'huge',
			],
		]
