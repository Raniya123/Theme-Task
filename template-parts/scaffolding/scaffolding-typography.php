...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'typography', 'test-theme' ); ?>">
		<?php esc_html_e( 'Typography', 'test-theme' ); ?></h2>
	...
	print_scaffolding_section(
		[
			...
			'usage'       => '<del>Test Theme</del>',
			'output'      => '<p>We use <del>Test Theme</del> wd_s to build themes.</p>',
		]
	);
